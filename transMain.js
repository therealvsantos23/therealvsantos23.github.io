...
function drawShapes() {
    ...
    let modelCylinderMatrix = glMatrix.mat4.create();
    let modelCylinderMatrix1 = glMatrix.mat4.create();
    let modelCylinderMatrix2 = glMatrix.mat4.create();

    let modelCubeMatrix = glMatrix.mat4.create();
    let modelCubeMatrix1 = glMatrix.mat4.create();
    let modelCubeMatrix2 = glMatrix.mat4.create();
    let modelCubeMatrix3 = glMatrix.mat4.create();
    let modelCubeMatrix4 = glMatrix.mat4.create();
    let modelCubeMatrix5 = glMatrix.mat4.create();

    let modelSphereMatrix = glMatrix.mat4.create();

    let modelConeMatrix = glMatrix.mat4.create();
    ...
    gl.uniformMatrix4fv (program.uModelT, false, modelCylinderMatrix);
    gl.bindVertexArray(myCylinder.VAO);
    gl.drawElements(gl.TRIANGLES, myCylinder.indices.length, gl.UNSIGNED_SHORT, 0);

    gl.uniformMatrix4fv (program.uModelT, false, modelCylinderMatrix1);
    gl.bindVertexArray(myCylinder.VAO);
    gl.drawElements(gl.TRIANGLES, myCylinder.indices.length, gl.UNSIGNED_SHORT, 0);

    gl.uniformMatrix4fv (program.uModelT, false, modelCylinderMatrix2);
    gl.bindVertexArray(myCylinder.VAO);
    gl.drawElements(gl.TRIANGLES, myCylinder.indices.length, gl.UNSIGNED_SHORT, 0);

    gl.uniformMatrix4fv (program.uModelT, false, modelCubeMatrix);
    gl.bindVertexArray(myCube.VAO);
    gl.drawElements(gl.TRIANGLES, myCube.indices.length, gl.UNSIGNED_SHORT, 0);

    gl.uniformMatrix4fv (program.uModelT, false, modelCubeMatrix1);
    gl.bindVertexArray(myCube.VAO);
    gl.drawElements(gl.TRIANGLES, myCube.indices.length, gl.UNSIGNED_SHORT, 0);

    gl.uniformMatrix4fv (program.uModelT, false, modelCubeMatrix2);
    gl.bindVertexArray(myCube.VAO);
    gl.drawElements(gl.TRIANGLES, myCube.indices.length, gl.UNSIGNED_SHORT, 0);

    gl.uniformMatrix4fv (program.uModelT, false, modelCubeMatrix3);
    gl.bindVertexArray(myCube.VAO);
    gl.drawElements(gl.TRIANGLES, myCube.indices.length, gl.UNSIGNED_SHORT, 0);

    gl.uniformMatrix4fv (program.uModelT, false, modelCubeMatrix4);
    gl.bindVertexArray(myCube.VAO);
    gl.drawElements(gl.TRIANGLES, myCube.indices.length, gl.UNSIGNED_SHORT, 0);

    gl.uniformMatrix4fv (program.uModelT, false, modelCubeMatrix5);
    gl.bindVertexArray(myCube.VAO);
    gl.drawElements(gl.TRIANGLES, myCube.indices.length, gl.UNSIGNED_SHORT, 0);

    gl.uniformMatrix4fv (program.uModelT, false, modelSphereMatrix);
    gl.bindVertexArray(mySphere.VAO);
    gl.drawElements(gl.TRIANGLES, mySphere.indices.length, gl.UNSIGNED_SHORT, 0);

    gl.uniformMatrix4fv (program.uModelT, false, modelConeMatrix);
